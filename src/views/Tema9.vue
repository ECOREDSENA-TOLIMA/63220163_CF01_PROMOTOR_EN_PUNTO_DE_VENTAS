  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 9
      h1 Métodos físicos y psicológicos para incentivar la venta
    ...
    .row.mb-4.p-4.justify-content-center.align-items-center
      .col-lg-4.col-8.mb-lg-0.mb-4(data-aos="fade-right")
        ...
        figure 
          img(src='@/assets/curso/temas/tema9/img-02.svg', alt='')
      .col-lg-6.col-12(data-aos="fade-right")
        LineaTiempoD.color-acento-botones
          p(numero="1" titulo="Influenciador") Participante en el proceso que busca estimular la intención de compra; papel que puede jugar el impulsador, pero también se da por un anuncio, un consejo de una persona cercana u otro tipo de influenciador. 
          p(numero="2" titulo="El decisor") Quien tiene el poder de decisión de compra. Por ejemplo, en el supermercado cuando se va en pareja, es decisor quien determina que se incluye en el carrito de mercado para la compra. 
          p(numero="3" titulo="El comprador") Es quien realiza físicamente la compra y no siempre es el decisor.
          p(numero="4" titulo="El consumidor") Quien utiliza el producto.
          p(numero="5" titulo="El evaluador") Quien valora la calidad del producto, generalmente es el consumidor. 
    
    .bloque-texto-g.bloque-texto-g--inverso.color-secundario.p-3.p-sm-4.p-md-5.mb-5(data-aos="fade-down")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema9/img-03.png')})`}"
      )
      .bloque-texto-g__texto.p-4
        p.mb-0 La decisión de compra es el momento de verdad en la mercadotecnia, porque define si la estrategia de #[i marketing] ha funcionado o no. Las teorías de toma de decisiones varían dependiendo los autores o expertos del tema que la exponga, pero tienen algo en común: se basan en conceptos acerca de la naturaleza de la especie humana y los factores psicológicos, sociales y culturales que la rigen.  
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-9.mb-3(data-aos="fade-left")
        p El comportamiento del #[i shopper] en el punto de ventas, asume tres procederes genéricos:
        ol.lista-ol--cuadro
          li 
            .lista-ol--cuadro__vineta
              span(style="color:#000") a
            | La búsqueda de la sección donde está el producto, observación de la sección y comparación entre las marcas.

          li 
            .lista-ol--cuadro__vineta
              span(style="color:#000") b
            | La atención  y permanencia en la parte de la sección que le atrajo sobre un producto (interés en un producto).
        ...
        p En los dos últimos pasos (b y c) debe abordarse al #[i shopper], teniendo en cuenta que es aquí donde él verifica el producto y lo aprueba, por lo tanto, es la oportunidad para incentivarlo y propiciar la compra.
    ...
    p.mb-5 Algunas estrategias de #[i merchandising] a considerar como ampliación del concepto de punto de venta:
